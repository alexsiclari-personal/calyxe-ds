 ...
 * 
 * Semantic color tokens for background elements.
...
export const backgroundColors = {
  ...
  // White background - specific option from Figma
  white: '#ffffff',
...
export type BackgroundSemantic = keyof typeof backgroundColors;
export type BackgroundVariation = 'lighter' | 'light' | 'default' | 'dark' | 'darker';
